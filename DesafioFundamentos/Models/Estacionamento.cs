namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            veiculos.Add(placa);
            Console.WriteLine($"Veiculo de placa: {placa} foi adicionado no parque.");
        }
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {
                ...
                // *IMPLEMENTE AQUI*
                 Console.WriteLine($"O Veiculo de placa:{placa} ficou {horas} horas.");
        ...
        public void ListarVeiculos()
        {
            ...
            {
                Console.WriteLine("Não há veículos estacionados no parque.");
            }
        }
    }
}
